...
import {
  ...
  FiPlus, FiEdit2, FiTrash2, FiEye, FiLogOut,
...
const EMPTY_PRODUCT = { name: '', category: 'Vegetables', price: '', stock: '', emoji: '🛒', status: 'active' };
...
export default function VendorDashboard() {
  ...
  useEffect(() => {
    const sync = () => setAvatar(localStorage.getItem(`avatar_${auth?.user?.id}`) || null);
